    ...
    "paths": {
        ...
        "/reasons": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal Server Error: Failed to retrieve report reasons",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/reasons/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Report reason retrieved successfully",
                        "schema": {
                            "$ref": "#/definitions/models.ReportReason"
                        }
                    },
                    "400": {
                        "description": "Bad Request: Invalid report reason ID",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error: Failed to retrieve report reason",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/reportAnnonce": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Reported Annonce Data",
                        "name": "reportedAnnonce",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReportedAnnonce"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Reported annonce created successfully",
                        "schema": {
                            "type": "string"
                        }
                    },
                    ...
                    "500": {
                        "description": "Internal Server Error: Failed to create reported annonce",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/reportMessage": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Reported Message Data",
                        "name": "reportedMessage",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReportedMessage"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Reported message created successfully",
                        "schema": {
                            "type": "string"
                        }
                    },
                    ...
                    "500": {
                        "description": "Internal Server Error: Failed to create reported message",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/reportSocket": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal Server Error: Failed to handle WebSocket connection",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/reports": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of reported messages and annonces",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "object",
                    ...
                    "500": {
                        "description": "Internal Server Error: Failed to retrieve reported messages and annonces",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/reports/annonces": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of reported annonces",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "object",
                    ...
                    "500": {
                        "description": "Internal Server Error: Failed to retrieve reported annonces",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/reports/messages": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of reported messages",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "object",
                    ...
                    "500": {
                        "description": "Internal Server Error: Failed to retrieve reported messages",
                        "schema": {
                            "type": "string"
                        }
                    }
